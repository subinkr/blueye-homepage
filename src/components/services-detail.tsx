...
import { Building2, Home, Users, TrendingUp, ArrowRight } from 'lucide-react'
            ...
            >
              <div className="relative bg-white rounded-2xl p-8 shadow-lg hover-lift border border-gray-100">
                ...
                <Button
                  variant="outline"
                  size="sm"
                  className="mt-4 group-hover:bg-primary-600 group-hover:text-white transition-all duration-300"
                >
